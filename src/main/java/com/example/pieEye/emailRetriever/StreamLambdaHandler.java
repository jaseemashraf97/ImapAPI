...
/**
 * This class contains everything thatis required for deploying this application as a serverless.
 */
public class StreamLambdaHandler implements RequestStreamHandler {
    ...
    static {
        try {
            handler = SpringBootLambdaContainerHandler.getAwsProxyHandler(EmailRetrieverApplication.class);
